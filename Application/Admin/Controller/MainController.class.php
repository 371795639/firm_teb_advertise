...
class MainController extends AdminController {
    ...
    public function notice($method = null){
        ...
        foreach ($resNotice as $key=> $value )
        {
            ...
            if(strlen($resNotice[$key]['notice_content']) < 80){
                $noticeData[$key]['n_content'] = $resNotice[$key]['notice_content'];
        }else{
                $noticeData[$key]['n_content'] = msubstr($resNotice[$key]['notice_content'],0,30);
        }
        }
...
<<<<<<< HEAD
        /*
=======
>>>>>>> 196a1625e6c7a1151f01c9a92fbddf24757fa049
        $field = null;
...
>>>>>>> 196a1625e6c7a1151f01c9a92fbddf24757fa049
    ...
    public function taskEdit(){
        ...
        if(IS_POST){
            ...
            $resStaff = $dbTask -> where($where) -> save($data);
            if($resStaff == 0){
