...
class AdminController extends Controller {
     ...
     * 通用分页列表数据集获取方法
     *
     *  可以通过url参数传递where条件,例如:  task_list.html?name=asdfasdfasdfddds
     *  可以通过url空值排序字段和方式,例如: task_list.html?_field=id&_order=asc
     *  可以通过url参数r指定每页数据条数,例如: task_list.html?r=5
     *
    ...
    protected function lists ($model,$where=array(),$order='',$base = array('status'=>array('egt',0)),$field=true){
        ...
        if( isset($REQUEST['r']) ){
            ...
            $listRows = C('LIST_ROWS2') > 0 ? C('LIST_ROWS2') : 10;
        }
