...
//        var_dump($result);die;
		...
		/****
		 array (size=9)
		'appid' => string 'wxb8e93b6fd864e341' (length=18)
		'err_code' => string 'USERPAYING' (length=10)
		'err_code_des' => string '需要用户输入支付密码' (length=30)
		'mch_id' => string '1354827902' (length=10)
		'nonce_str' => string 'B5VGQdCKOBkdTL9B' (length=16)
		'result_code' => string 'FAIL' (length=4)
		'return_code' => string 'SUCCESS' (length=7)
		'return_msg' => string 'OK' (length=2)
		'sign' => string '8E17873F7F2B829E4488B5B570019854' (length=32)
		***out_trade_no不存在***/
